...
Redis server implementation in C++23 (3,600 LOC, zero dependencies), featuring an epoll-based event loop, RESP protocol support, master-replica replication, Pub/Sub, Streams, Sorted Sets, Geo commands, ACL authentication, and more. **39 Redis commands** across 10 modules. Core operations outperform Redis 6.0 by ~3% at ~310K ops/s with a 291 KB binary.
